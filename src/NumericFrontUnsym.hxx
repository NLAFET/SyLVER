...
namespace splu {
   ...
   class NumericFrontUnsym : public sylver::NumericFrontBase<T, PoolAllocator> {
   public:
   ...
   public:
      ...
      NumericFrontUnsym<T, PoolAllocator>* first_child; // Pointer to our first child
      NumericFrontUnsym<T, PoolAllocator>* next_child; // Pointer to parent's next child
